...
class EaModel(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        # super(EaModel, self).__init__(**kwargs)
        self.base_model = base_model
        self.config = base_model.config
        self.hidden_size = base_model.lm_head.weight.shape[-1]
        self.vocab_size = base_model.lm_head.weight.shape[0]
        self.base_model_name_or_path = base_model_name_or_path
        # self.tokenizer = AutoTokenizer.from_pretrained(self.base_model_name_or_path, trust_remote_code=True, pad_token="<|endoftext|>")
        self.tokenizer = AutoTokenizer.from_pretrained(self.base_model_name_or_path,**kwargs)
        config = EConfig.from_pretrained(ea_model_path,**kwargs)
        # config = QWenConfig.from_pretrained(ea_model_path,trust_remote_code=True)
        # config = AutoConfig.from_pretrained(ea_model_path, trust_remote_code=True)
    ...
    def get_tokenizer(self):
        ...
        Returns:
            Tokenizer: The tokenizer of the base model.f
        """
    ...
    def from_pretrained(
        ...
        #     base_model = KVQWenLMHeadModel.from_pretrained(
        #         base_model_path, **kwargs
        #     )
        else:
        ...
        # ea_layer_state_dict = {}
        # with safe_open(load_model_path,framework='pt',device='cpu') as f:
        #     for key in f.keys():
        #         ea_layer_state_dict[key] = f.get_tensor(key)
